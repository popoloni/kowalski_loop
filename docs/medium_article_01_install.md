...
<!-- ![Local AI Setup on Apple Silicon — Terminal running Claude Code against a local model](img/measuring_kowalski.png) -->
...
<!-- ![Local AI Trade-offs: Cloud vs Local models comparison](img/llm_comparison/crash_risk_curve.png) -->
...
<!-- ![Performance Benchmarks: 3-model comparison on Apple Silicon — Qwen3.6 Dense, DFlash, and Sparse MoE at 24K tokens](img/llm_comparison/ornith_vs_qwen35_ab.png) -->
...
<!-- ![DFlash Architecture: Block Diffusion for Flash Speculative Decoding — Draft & Verify pipeline](img/dflash/cache_band_latency.png) -->
...
<!-- ![Claude Code interface running against local model via ccr router](img/dflash/dflash_session_d00_20260620_2012.png) -->
...
<!-- ![Resulting code output from local agentic loop](img/headroom/headroom_session_h00_20260621_2359.png) -->
the resulting code
#Conclusion
